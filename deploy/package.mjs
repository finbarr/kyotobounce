...
const files=['package.json','package-lock.json','web/public','web/server.ts','web/social-metadata.ts','web/connection-queue.ts','web/performance.ts','web/shot-stream.ts','web/store.ts','web/replay-cache.ts','web/replay-http.ts','web/level-http.ts','web/competition.ts','web/types.ts','web/scoring.ts','web/worker.ts','web/starter-challenges.json','Builds/PhysicsWorkerLinux','deploy'];
