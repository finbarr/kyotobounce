...
for(let i=1;i<=180;i++){
 p.walked=i/60*1.4;p.movement.z=1.4;poseAvatar(a,p,'Aim',state,i/60);
...
assert.ok(a.walkBlend<.00001);feet().forEach((p,i)=>assert.ok(p.distanceTo(base[i])<.001,'Rest pose returns without accumulating offsets'));
