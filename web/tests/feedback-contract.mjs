...
try{
 ...
 await page.evaluate(async()=>{
  ...
  window.fixture=(mult=1,version='combo-v7')=>({version,potential:10000*mult,total:2500*mult,bankMultiplier:mult,comboMultiplier:mult,bankBonus:mult-1,styleBanks:2*(mult-1),goalVisited:false,landingMultiplier:.25,lastBank:'STEEL BANK'});
 });
