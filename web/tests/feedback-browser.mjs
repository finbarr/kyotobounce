...
try{
 ...
 await page.keyboard.down('Space');await page.waitForFunction(()=>window.kyotoState.charging,null,{timeout:15000});console.log('Charging');await page.waitForTimeout(1900);await page.keyboard.up('Space');await page.waitForFunction(()=>window.kyotoState.phase==='Flight');
