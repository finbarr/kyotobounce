...
export function competitionUI({scene,send,cancel,notice,getGuestId,getLiveTime,getPhase,resetView,overview,sound}){
 ...
 const state={mode:'play',session:null,challenges:[],selected:null,board:[],draft:{start:null,goal:null,waypoints:[],scoring:'waypoint-v1'},selectedWaypoint:null,editId:null,placing:null,replay:null,replayTime:0,replayPlaying:false,lastResult:null,hint:null};
